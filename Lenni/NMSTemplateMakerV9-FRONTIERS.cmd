...
ECHO ^| galaxy = Euclid>> "!wikiTypeShipName!.txt"
...
ECHO ^| cost = !wikiTypeCost! Units>> "!wikiTypeShipName!.txt"
...
ECHO.>> "!wikiTypeShipName!.txt"
ECHO if !wikiTypeType!==Exotic OR !wikiTypeType!==Living Ship (This starship always spawns in S-class.) ELSE (This starship has a 0/1/2% chance to spawn in S-class.)>> "!wikiTypeShipName!.txt"
ECHO.>> "!wikiTypeShipName!.txt"
...
ECHO {{LivingShipStats}}>> "!wikiTypeShipName!.txt"
ECHO {{ExoticShipStats}}>> "!wikiTypeShipName!.txt"
ECHO {{ShuttleShipStats}}>> "!wikiTypeShipName!.txt"
ECHO {{FighterShipStats}}>> "!wikiTypeShipName!.txt"
ECHO {{HaulerShipStats}}>> "!wikiTypeShipName!.txt"
ECHO {{ExplorerShipStats}}>> "!wikiTypeShipName!.txt"
ECHO.>> "!wikiTypeShipName!.txt"
...
ECHO <gallery> >> "!wikiTypeShipName!.txt"
ECHO NAME.jpg^|Rear view of ship
ECHO NAME.jpg^|Inventory screen
ECHO NAME.jpg^|NPC Ship Pilot
ECHO NAME.jpg^|Analysis Visor Scan
ECHO NAME.jpg^|System Page
ECHO </gallery> >> "!wikiTypeShipName!.txt"
