...
const systemElementFunctions: ElementFunctions = [
  ...
  },
  {
    ...
    func: function () {
      wikiCodePercentage(this as unknown as HTMLInputElement, 1);
    },
  },
  {
    element: ['wealthInput', 'conflictInput'],
    func: function () {
      autoPirate(this as unknown as HTMLSelectElement);
    },
  },
  {
  ...
  },
  {
    ...
    func: function () {
      addTemplate(this as unknown as HTMLInputElement);
    },
  },
  {
    element: 'merchantSearch',
    func: function () {
      searchUpgrades(this as unknown as HTMLInputElement);
    },
  },
  {
  ...
  },
  {
    ...
    handler: 'click',
    func: function () {
      toggleSection('MTMerchant', this as unknown as HTMLButtonElement);
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      toggleSection('SSMerchant', this as unknown as HTMLButtonElement);
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      toggleSection('ECMerchant', this as unknown as HTMLButtonElement);
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      toggleSection('ESMerchant', this as unknown as HTMLButtonElement);
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      toggleSection('SDMerchant', this as unknown as HTMLButtonElement);
    },
  },
  {
