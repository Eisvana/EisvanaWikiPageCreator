...
const robotData: CreatureDataObject[] = [
	{
		values: ['Pure Silicon', 'Siphoned Data', '[[Nanite Cluster]]s', 'Recycled Heat', 'Cosmic Rays', 'Decaying Atoms', 'Random', 'Interlopers'],
...
const fishDiet: CreatureDataObject[] = [
	{
		values: ['Marine snow', 'Chemosynthesis', 'Vented minerals', 'Plankton', 'Seaweed', 'Deepwater algae', 'Small crustaceans', 'Rotten wood', 'Decayed plant life', 'Marine detritus', 'Algal particulates', 'Coral', 'Living sponges', 'Deepwater spores', 'Nibbles at moss', 'Hydrothermal minerals', 'Water filtration', 'Drifting plants', 'Silicates', 'High in calcium', 'Water vines', '[[Kelp Sac|Kelp sacs]]', 'Nutritious water weeds'],
		sentences: ['Scavengers, they feed upon the soft downward drift of plankton; feasting upon the dying remains of tiny organisms.']
	},
]
	...
	const dietSentences: { DietDescriptions: Diets, WaterDietDescriptions: Diets } = {
		DietDescriptions: {
			Carnivore: [
				...
				{
					values: ['Meat-eater'],
					sentences: ['Exclusively carnivorous, they feast upon the flesh of other creatures. None are spared from their jaws.'],
				},
				{
					values: ['Hypnotises prey'],
					sentences: ['Unyielding, hypnotic eyes mesmerise their prey, allowing them to feast upon other creatures without the mortal peril of the hunt.'],
				},
				{
					values: ['Crunches bones'],
					sentences: ['Sharp teeth and powerful jaws allow them to crunch through the carcasses of their prey, feasting upon flesh and bone alike.'],
				},
				{
					values: ['Blood-drinker'],
					sentences: ['They feast upon their prey only when fresh, guzzling blood while it is still hot. Cold corpses and old meat are left for the scavengers.'],
				},
				{
					values: ['Liquidised organs'],
					sentences: ['They digest their meals before they consume them. Powerful enzymes are injected directly into their prey; their liquid flesh is then drunk at leisure.'],
				},
				{
					values: ['Extracts bone marrow'],
					sentences: ['Carnivores, they prefer to hunt larger creatures. They strip the flesh from the bones of their prey before finally consuming the marrow in a way that is almost ritualistic.'],
				},
				{
					values: ['Organs'],
					sentences: ['Extremely well-adapted toxin removal systems allow them to consume prey in its entirety, from the standard flesh to the richly nutritious but frequently hazardous offal.'],
				},
				{
					values: ['Raw meat'],
					sentences: ['Unsophisticated and unrestrained carnivores, they feast upon the raw flesh of their fallen prey.'],
				},
				{
					values: ['Flesh-eater'],
					sentences: ['Dental analysis reveals jaws and teeth well-adapted to the ripping of flesh from bones, to the chewing life from other beings.'],
				},
				{
				...
				{
					values: ['Brain matter'],
					sentences: ['After making a kill, these carnivorous beasts shatter the skulls of their prey and offer the brain matter to the oldest member of their pack.'],
				},
				{
					values: ['Sinew'],
					sentences: ['Row after row of highly-polished teeth allow them to tear through flesh and sinew alike. They can strip a corpse to the bone in minutes.'],
				},
				{
					values: ['Fresh meat'],
					sentences: ['Well-adapted to the hunt but poorly-adapted to digestion, these carnivores will only feast upon the freshest of meat.'],
				},
				{
					values: ['Corpses'],
					sentences: ["Carnivorous but opportunistic, these beasts will happily raid the corpse of some other hunter's prey."],
				},
				{
					values: ['Putrefied meat'],
					sentences: ['While physically weaker than some other carnivorous species, these creatures gain their advantage in the strength of their digestive tract. They will happily consume month-old corpses and suffer no ill-effect, no bacterial retaliation.'],
				},
				{
					values: ['Cannibal'],
					sentences: ['All-consuming in their hunger, these carnivores will turn cannibal with little provocation, happy to feast upon their kin.'],
				},
				{
					values: ['Offal'],
					sentences: ['Carnivores, they happily tear through the flesh of their prey, desperate to feast upon the offal found deep within the carcass.'],
				},
				{
					values: ['Removed hearts'],
					sentences: ['Clean, fastidious eaters. They butcher the corpses of their prey, preparing each chunk of flesh on some instinctive schedule. They appear to reserve the hearts of their prey for consumption only during specific lunar phases.'],
				},
				{
					values: ['Small animals'],
					sentences: ['They prefer to acquire their meat from sources that will not fight back. Quick jaws and sharp eyes allow them to prey upon the small, darting creatures that other hunters leave behind.'],
				},
				{
					values: ['Other carnivores'],
					sentences: ['These are hypercarnivores, powerful predators at the top of the food chain. These are the beasts that hunt the hunters.'],
				},
				{
				...
				{
					values: ['Flesh chunks'],
					sentences: ['Carnivores, their appetite for flesh knows no bounds. They swallow it down in great chunks, ripped from the bones of their prey.'],
				},
				{
					values: ['Meat chunks'],
					sentences: ['Brutal carnivores, they will begin their bloody feasts even while their prey continues to thrash, its death throes not yet complete.'],
				},
				{
					values: ['Coagulated blood'],
					sentences: ['After making a kill, they will preserve the blood of their prey in coagulated lumps. These stores serve them well during lean patches, times when their hunts go unsuccessful.'],
				},
				{
			...
			Omnivore: [
				{
					...
					sentences: ['Scavengers, they plunder the stores of other animals, stealing bones and scraps wherever they find them.']
				},
				{
					values: ['Insects and grubs'],
					sentences: ['Their tongues are razor sharp and lightning-quick, allowing them to catch and skewer the small insects that make up the majority of their diet.']
				},
				{
					values: ['Worms'],
					sentences: ['They push through worm piles with their strong snouts, slurping down whole tangled colonies in mere moments.']
				},
				{
					values: ['Anything'],
				...
				{
					values: ['Birds'],
					sentences: ['Quick-witted and sharp, they prey upon any unsuspecting or inattentive birds who linger too low to the ground.']
				},
				{
					values: ['Scavenged remains'],
					sentences: ['Sneaky and opportunistic, they steal from the kills of larger predators, nipping in and making away with whatever they can.']
				},
				{
					values: ['Partially-digested meat'],
					sentences: ['Omnivores, they gobble down anything they are able to find. Powerful digestive enzymes allow them to make use of the discarded scraps left behind by more powerful predators.']
				},
				{
					values: ['Eggs'],
					sentences: ['While not adapted for open confrontation, they are nonetheless impressive hunters. Under the cover of darkness, they steal into nests and feast upon eggs and hatchlings alike.']
				},
				{
					values: ['Steals from others'],
					sentences: ['Omnivorous and thieving, they eat whatever they find, wherever they find it. Frequently, this means consuming the hard-won stores of other animals.']
				},
				{
				...
				},
				{
					...
					sentences: ['Omnivorous and greedy, they feast upon the unwanted scraps left behind by creatures with more specifically adapted diets.']
				},
				{
					values: ['Small animals'],
					sentences: ['Ill-equipped to compete with large animals, they choose to prey upon smaller foes. Rodents, insects, nitrogen-rich plantlife - anything unlikely to fight back.']
				},
				{
					values: ['Old bones'],
					sentences: ['Well-adapted digestive systems allow them to find nutrients where others would give up. They happily feast upon the marrow of discarded bones, cracking them open and guzzling their nutritious cores.']
				},
				{
					values: ['[[Mordite]]'],
					sentences: ['Drawn to the smell of death, their primary nutrient source is Mordite. They do not discriminate between beast or plant.']
				},
			],
			Herbivore: [
				{
				...
				},
				{
					...
					sentences: ['Highly specialised sense organs allow them to dig through the fecal deposits of other creatures, sniffing out and consuming the nutrients within.']
				},
				{
					values: ['Mostly rocks'],
					sentences: ['Dense teeth and a series of extremely acidic stomachs allow them to consume a diet mostly consisting of rocks.']
				},
				{
				...
				},
				{
					...
					sentences: ['They snuffle for food with their noses dug into the dirt, flicking earth into their mouths with long, spiked tongues. Nutrient source is presumed to be soil-bound microorganisms.']
				},
				{
				...
				},
				{
					...
					sentences: ['Their diet is largely conventional, consisting largely of local flora. But the scent of Nip Nip drives them to a frenzy, and they will gorge upon its buds.']
				},
				{
					values: ['[[Gravitino Ball|Gravitino balls]]'],
					sentences: ['Pugneum-infused teeth allow them to consume and digest gravitino balls, crunching through their outer shells in an explosion of light.']
				},
				{
					values: ['Stinging leaves'],
					sentences: ['Their tongues are hairy and thick, allowing them to happily chew upon all but the most venomous of leaves.']
				},
				{
					values: ['Algae'],
					sentences: ['Filtering gills inside their cheeks allow them to suck up water and extract nutrients from algal blooms.']
				},
				{
					values: ['Flowers'],
					sentences: ['They supplement their tuber-based diet with brightly-coloured flowers; the complex dye compounds providing a valuable micronutrient boost.']
				},
				{
					values: ['Petals'],
					sentences: ['Their finely-tuned sense of smell draws them to the most beautiful, richly-scented flowers, which they then consume whole.']
				},
				{
					values: ['Nectar'],
					sentences: ['A specially-adapted tongue indicates their diet is predominantly nectar, harvested from local flora.']
				},
				{
					values: ['Pollen'],
					sentences: ['A gnawing hunger for sugar drives their every waking moment; their existence a constant hunt from sweet plant to the next.']
				},
			],
			Robot: robotData
		},
		WaterDietDescriptions: {
			Carnivore: [
				{
					values: ['Other fish', 'Cannibalism', 'Marine eggs', 'Turtles', 'Shellfish', 'Drifting carcasses', 'Bones', 'Hunts squid', 'Brined organs', 'Salinated flesh', 'Brains', 'Blood', 'Gelatinous chunks', 'Wasteflesh'],
					sentences: ['Aggressive hunters, they make a meal of any fish unfortunate enough to get caught in their jaws.']
				},
			],
			Omnivore: fishDiet,
			Herbivore: fishDiet,
