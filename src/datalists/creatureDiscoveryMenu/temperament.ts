...
const temperamentSentences: { [key: string]: { [key: string]: string[] } } = {
  ...
  Bird: {
    ...
    'Easily scared': [
      'Powerful lateral muscles allow them to take off with remarkable speed, taking to the air faster than any ground predator could possibly lunge.',
    ],
  ...
  FishPrey: {
    ...
    Lonely: [
      'No matter the size of their shoal, the lack of any communicative organs leaves these fish with a profound sense of loneliness.',
    ],
    Observant: [
