...
const settingsElementFunctions: ElementFunctions = [
  {
    ...
    func: function () {
      hideDiscoverer('discoveredDefault', 'discoveredlinkDefault');
    },
  },
  {
    element: 'discoveredlinkDefault',
    func: function () {
      hideDiscoverer('discoveredlinkDefault', 'discoveredDefault');
    },
  },
  {
    ...
    func: function () {
      ...
      (document.getElementById('settingsPortalglyphsPreview') as HTMLOutputElement).value = validateGlyphInput(
        element.value
      );
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      deleteCharacter(this as unknown as HTMLButtonElement);
    },
  },
  {
    element: 'switchTheme',
