...
const evtListenerObj: ElementFunctions = [
  {
    ...
    handler: 'click',
    func: function () {
      copyCode(this as unknown as HTMLButtonElement, 'fullArticle');
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      downloadFile(this as unknown as HTMLAnchorElement);
    },
  },
  {
    ...
    handler: 'click',
    func: function () {
      createPage(this as unknown as HTMLAnchorElement);
    },
  },
  {
    element: 'resetButton',
