...
const elementFunctions: ElementFunctions = [
  ...
  },
  {
    ...
    func: function () {
      glyphInputOnChange(this as unknown as HTMLInputElement);
      displayGlyphs();
      enableTextMarking();
    },
  },
  {
    ...
    func: function () {
      hideDiscoverer('discoveredInput', 'discoveredlinkInput');
      docBy();
    },
  },
  {
    ...
    func: function () {
      hideDiscoverer('discoveredlinkInput', 'discoveredInput');
      docBy();
    },
  },
  {
