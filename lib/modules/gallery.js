	...
	for (let fileIndex = 0; fileIndex < inp.files.length; fileIndex++) {
		...
		<div id="${galleryId}" class="gallery-item">
			...
			<div class="controlButtons">
				<span class="delete-icon is-clickable" onclick="rmGallery(this, '${wikiCodeGalleryId}');">&#10060</span>
				<img class="handle" src="./lib/arrow.svg">
				<button style="display:none" class="moveButton" onclick="mobileMoveItem(this, '${wikiCodeGalleryId}', 'up')">
					<svg width="36" height="36"><path d="M2 25h32L18 9 2 25Z"></path></svg>
				</button>
				<button style="display:none" class="moveButton" onclick="mobileMoveItem(this, '${wikiCodeGalleryId}', 'down')">
