...
function civGalaxy(inputId) {
	...
	switch(document.getElementById(inputId).value) {
		case "GHub":
			document.getElementById(civStub).innerHTML = 'GHub';
			document.getElementById(civilized).innerHTML = 'Galactic Hub Project';
			document.getElementById(galaxy).innerHTML = 'Euclid';
		break;

		case "CalHub":
			document.getElementById(civStub).innerHTML = 'GHub Calypso';
			document.getElementById(civilized).innerHTML = 'Galactic Hub Calypso';
			document.getElementById(galaxy).innerHTML = 'Calypso';
		break;

		case "EisHub":
			document.getElementById(civStub).innerHTML = 'GHub Eissentam';
			document.getElementById(civilized).innerHTML = 'Galactic Hub Eissentam';
			document.getElementById(galaxy).innerHTML = 'Eissentam';
		break;
	}
}