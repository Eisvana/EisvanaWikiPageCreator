...
function getNumber(number, decimals = null) {
...
function numberStats(element, decimals = null) {
...
function numberError(element, value = element.value, decimals = null) {
	const number = getNumber(value, decimals);
	if (number || !value) {
		errorMessage(element);
	} else {
...
function assignDefaultValue(element, value) {
