...
function getCodeValue(codeId) {
	return document.getElementById(codeId).innerText
}
...
function codeFunction(codeId_new, codeId_org) {
	let text = document.getElementById(codeId_org).innerText
	text = input = sanitiseString(text)
	document.getElementById(codeId_new).innerText = text
}
...
function researchTeamDropdown(civ_inputId, researchteam_inputId) {
	...
	const teams = ['', 'GHGS', 'GHEC', 'GHSH', 'GHDF', 'GHBG', 'GHSL', 'GHTD'];
