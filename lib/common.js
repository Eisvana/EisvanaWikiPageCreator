...
function sanitizeString(input) {
	...
	let text = input;
	text = text.replaceAll('[http', linkReplacement)	// catch [link alias] syntax
	for (const markup of wikiMarkup) {
	...
	text = text.replaceAll(linkReplacement, '[http')	// catch [link alias] syntax
	return text;
}
