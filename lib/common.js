...
const elementFunctions = {
	researchTeam: ['researchTeam(); docBy()', 'onchange'],
	civ: ['civ()', 'onchange'],
...
function hideDiscoverer(keepId, removeId) {
	...
	const destKeep = keepInput.getAttribute('data-dest')
	const destRemove = removeInput.getAttribute('data-dest')
	pageData[destKeep] = keepInput.value;
	pageData[destRemove] = '';
}
