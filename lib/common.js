...
function resetAll(inputId) {
	...
	var child = document.getElementById(inputId)
...
function galleryUpload(uploadId, descId, codeId) {
	...
	for (var i = 0; i < inp.files.length; ++i) {
		...
		input.setAttribute('oninput', "document.getElementById(\'" + galleryId + "\').innerHTML = \'\\|\' + document.getElementById(\'" + inputId + "\').value");
	}
