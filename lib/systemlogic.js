...
function merchantUpgrades(MTName, SSName, ECName, ESName, codeId) {
	const checkboxes = {
		MTCheckboxes: checkBoxFunctionMultiple(MTName),
		SSCheckboxes: checkBoxFunctionMultiple(SSName),
		ECCheckboxes: checkBoxFunctionMultiple(ECName),
		ESCheckboxes: checkBoxFunctionMultiple(ESName)
	}
	const Upgrades = [];
