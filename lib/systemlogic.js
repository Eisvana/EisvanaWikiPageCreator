function planetMoon(planet_inputId, moon_inputId, input_placementId, planetmoons_codeId) {
    ...
    for (let i = 1; i <= bodies; i++) {
        ...
        <div>|{{Biome|<output id="biome${i}"></output>}} <output id="infested${i}"></output>- <output id="planetDescriptor${i}"></output></div>
...
/*         const inputTemplate = `<tr name="planet${i}">
    ...
    <tr name="planet${i}">
        ...
        <td><input type="checkbox" id="infested_input${i}1" onchange="if (this.checked) {this.value='([[Biome Subtype - Infested|Infested]]) '} else {this.value = ''}; document.getElementById('infested1').innerHTML = this.value">
    </tr>
    <tr name="planet${i}">
    ...
    <tr name="planet${i}">
        ...
        <td><input type="text" id="resource_input${i}1" oninput="hideResource(this, 'resource_input${i}2'); displayResource(this, 'resource${i}1')">
    </tr>
    <tr name="planet${i}" style="visibility:hidden">
    ...
    <tr name="planet${i}">
        ...
        <td><input type="number" id="faunatotal_input${i}" min="0" oninput="document.getElementById('faunatotal${i}').innerHTML = this.value">
    </tr>`
 */        
        ...
        inputRowId = 'planet' + i
        inputRows = document.getElementsByName(inputRowId)
