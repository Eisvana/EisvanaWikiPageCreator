...
function costSlotCalc(type_inputId, inventory_codeId cost_codeId, slots_codeId, techslots_codeId, cargoslots_codeId) {
	...
	switch (inventory) {
		case "Small":
			setOutput(cost_codeId, type['CostSmall'])
			setOutput(slots_codeId, type['SlotsSmall'])
			setOutput(techslots_codeId, type['TechSmall'])
			setOutput(cargoslots_codeId, type['CargoSmall'])
			break;
			
		case "Medium":
			setOutput(cost_codeId, type['CostMedium'])
			setOutput(slots_codeId, type['SlotsMedium'])
			setOutput(techslots_codeId, type['TechMedium'])
			setOutput(cargoslots_codeId, type['CargoMedium'])
			break;
			
		case "Large":
			setOutput(cost_codeId, type['CostLarge'])
			setOutput(slots_codeId, type['SlotsLarge'])
			setOutput(techslots_codeId, type['TechLarge'])
			setOutput(cargoslots_codeId, type['CargoLarge'])
			break;
	}
}
/*
