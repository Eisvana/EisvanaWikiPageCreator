...
function shipAppearance(name_inputId, type_inputId, mainColour_inputId, secColour_inputId, secParts_inputId, accessories_inputId, miscParts_inputId, appearance_inputId) {
	...
	const FighterSecParts = ['', 'Heavy', 'Starjumper', 'Horizon', 'Vector', 'Tie', 'Halo', 'Bowie-H', 'Bowie-V', 'Gull', 'Quasar', 'Vulture', 'Droid', 'Mecha-3', 'Mecha-5', 'Mecha-7', 'E-Wing', 'Aftershock', 'Shockwave', 'Starscream'];
	...
	const HaulerMiscParts = ['', 'High Wing', 'Serenity', '2rpedo', 'Sabre', 'V-Blade', 'Tilt'];

	const ShuttleSecParts = ['', 'Voyager', 'Grill Wing', 'Y-Wing', 'Bent Wing', 'Drop-Wing', 'X-Wing', 'Low Wing', 'Glider', 'V-Wing'];
	...
	const ExoticAccessories = ['', 'Side Wing', 'Side Booster'];
	...
	const FreighterAccessories = ['', 'Keel', 'Bottom Fin', 'Top Fin', 'W-Wing', 'Wedge', 'Nacelle'];
	...
	const output = `${name} is a ${mainColour.toLowerCase()} ${type.toLowerCase()} with ${secColour.toLowerCase()} accents. It features ${secParts.toLowerCase()}, ${accessories.toLowerCase()} and ${miscParts.toLowerCase()}.`
// {{#if: {{{primarycolor|}}}|It is mainly {{{primarycolor}}} {{#if: {{{secondarycolor|}}}|and {{{secondarycolor}}}|}} {{#if: {{{accent|}}}|with {{{accent}}} accents|}}.|}}
