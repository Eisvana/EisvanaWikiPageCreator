...
function showHide(type_inputId, subtypetrId, exotictrId, pilottrId, maneuvertrId, damagetrId, shieldtrId, warptrId) {
	const yes = 'table-row'
	const no = 'none'
	
	var type = document.getElementById(type_inputId).value
	var subtypetr = document.getElementById(subtypetrId)
	var exotictr = document.getElementById(exotictrId)
	var pilottr = document.getElementById(pilottrId)
	var maneuvertr = document.getElementById(maneuvertrId)
	var damagetr = document.getElementById(damagetrId)
	var shieldtr = document.getElementById(shieldtrId)
	var warptr = document.getElementById(warptrId)
