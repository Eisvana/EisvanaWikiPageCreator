...
function showHide(type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId, planet_inputId, moon_inputId, axes_inputId, economy_inputId) {
	const yes = ''
	const no = 'none'
...
function resetShip(galleryDesc, type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId, planet_inputId, moon_inputId, axes_inputId, economy_inputId) {
	...
	showHide(type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId, planet_inputId, moon_inputId, axes_inputId, economy_inputId)
