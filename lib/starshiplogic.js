...
function appearanceSentence(name_inputId, type_inputId, subtype_inputId, exotic_inputId, mainColour_inputId, secColour_inputId, secParts_inputId, accessories_inputId, miscParts_inputId, appearance_inputId) {
	...
	const output = `${name} is a ${mainColour.toLowerCase()} ${type.toLowerCase()} of the ${subtype.toLowerCase()} subtype with ${secColour.toLowerCase()} accents. It features ${secParts.toLowerCase()}, ${accessories.toLowerCase()} and ${miscParts.toLowerCase()}.`
