...
function showHide(type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId) {
	const yes = ''
	const no = 'none'
...
function resetShip(galleryDesc, type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId) {
	resetAll(galleryDesc)
	resetAll('gallery_descs')
	document.getElementById(type_inputId).value = 'Fighter';
	showHide(type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId)
