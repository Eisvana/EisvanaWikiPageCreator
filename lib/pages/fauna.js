...
const creatureElementFunctions = {
	...
	heightInput: ['genderProps("height", "height2"); albumOther()'],
	weightInput: ['genderProps("weight", "weight2")'],
	height2Input: ['genderProps("height", "height2"); albumOther()'],
...
function genderProps(property1Name, property2Name) {
	...
	if (property1Name != 'gender') {
		property1Number = parseFloat(property1Value).toFixed(1);
		property2Number = parseFloat(property2Value).toFixed(1);
	}

	const property1Data = isNaN(property1Number) ? '' : property1Number;
	const property2Data = isNaN(property2Number) ? '' : property2Number;
	pageData[property1Name] = property1Data;
	pageData[property2Name] = property2Data;

	const result = (() => {
		//if (property1Data == 'NaN' && property2Data == 'NaN') return '';
		if (gender2) {
