...
const systemElementFunctions = {
	civ: ['loc(); regionLong(); expectedHubTagSentence()', null, true],
	portalglyphsInput: ['loc(); regionLong(); expectedHubTagSentence()', null, true],
...
function planetInputs() {
	...
	function addPlanet(i) {
		...
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			<input type="text" id="weather_input${i}" list="weather" oninput="document.getElementById('weather${i}').innerText = this.value">
		</div>
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
...
const biomes = new Object;
function biomeLinks(element = null) {
	const value = element.value;
	const planet = element.dataset.destNoauto;
...
const infestedBiomes = new Object;
