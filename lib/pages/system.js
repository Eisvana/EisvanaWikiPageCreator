...
function planetInputs() {
	...
	function addPlanet(i) {
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Name',
			'Can be found in the planet discovery menu.<br>Enter exactly as seen in game. Watch out for 0 (zero) and O (o).',
			'./helperimg/planet/planetName.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the discovery menu.</span></span>
		</div>
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Name',
			'Should show the entire planet from space.<br>Make sure no asteroids/pulse lines/freighters are obstructing the picture.<br>Point the sun directly at the planet, no weird angles.<br>Also try to only get the planet into the shot, no other planets. Only exception to this are moons or rings, which should be included if they exist.<br>Disable the vignette.',
			'./helperimg/planet/planetPic.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Should show the entire planet from space. Click for an example picture.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			<label>Biome</label>
			<span class="tooltip" onclick="explanation('Planet Biome',
			'Can be determined from the planetary features such as the weather, harvestable plants or available resources.<br>See the <a href=https://nomanssky.fandom.com/wiki/Biome rel=noreferrer target=_blank>Biome wiki page</a> for more information.',
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be determined from the planetary features.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Infested Biome',
			'Can be determined from the planetary features such as the planet descriptor, the weather descriptor, or the alien looking flora.<br>See the <a href=https://nomanssky.fandom.com/wiki/Biome_Subtype_-_Infested rel=noreferrer target=_blank>wiki</a> for more information.',
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be determined from the planetary features.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Description',
			'Can be found in the exploration guide.',
			'./helperimg/planet/planetDesc.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the exploration guide.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableHeader text ${oddEvenClass} sectionToggle" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Resources', 
				'Found in the Discovery Menu or on the analysis visor.',
				'./helperimg/planet/resources.jpg'	
				)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Found in the Discovery Menu or on the analysis visor.
				</span></span>
			</div>
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Weather',
			'Can be found in the discovery menu.',
			'./helperimg/planet/weather.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the discovery menu.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Sentinel Level',
			'Can be found in the discovery menu.',
			'./helperimg/planet/sentinels.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the discovery menu.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Flora Level',
			'Can be found in the discovery menu.',
			'./helperimg/planet/flora.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the discovery menu.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Fauna Level',
			'Can be found in the discovery menu.',
			'./helperimg/planet/fauna.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the discovery menu.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
		...
		<div class="tableCell text ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
			...
			<span class="tooltip" onclick="explanation('Planet Fauna Number',
			'Can be found in the discovery menu.',
			'./helperimg/planet/faunaNum.jpg'
			)"><img src="./lib/help.svg"><span class="tooltiptext nms-font">
				Can be found in the discovery menu.</span></span>
		</div>
		<div class="tableCell data ${oddEvenClass}" data-planet="planet${i}" data-section="planet${i}">
