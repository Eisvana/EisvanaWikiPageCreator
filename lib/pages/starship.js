...
const Freighter = {
	...
	'SlotsLarge': '24-34',
	'TechSlotsSmall': '8-12',
	'TechSlotsLarge': '12-20',
}

const Exotic = {
	'CostSmall': '20,900,000 - 41,000,000',
	'SlotsSmall': '24-30',
	'TechSlotsSmall': '20-28',
}

const Solar = {
	'CostSmall': '4,000,000 - 14,000,000',
	'SlotsSmall': '24-30',
	'TechSlotsSmall': '13-18',
}

const Fighter = {
	'CostSmall': '4,050,000 - 15,650,000',
	'CostMedium': '4,050,000 - 27,650,000',
	'CostLarge': '10,500,000 - 57,500,000',
	'SlotsSmall': '24-28',
	'SlotsMedium': '24-32',
	'SlotsLarge': '30-38',
	'TechSlotsSmall': '14-19',
	'TechSlotsMedium': '14-24',
	'TechSlotsLarge': '19-30',
}

const Explorer = {
	'CostSmall': '3,450,000 - 11,900,000',
	'CostMedium': '3,450,000 - 18,300,000',
	'CostLarge': '9,200,000 - 39,000,000',
	'SlotsSmall': '24-29',
	'SlotsMedium': '24-32',
	'SlotsLarge': '30-38',
	'TechSlotsSmall': '14-19',
	'TechSlotsMedium': '19-24',
	'TechSlotsLarge': '24-30',
}

const Hauler = {
	'CostSmall': '9,700,000 - 37,500,000',
	'CostMedium': '20,850,000 - 58,500,000',
	'CostLarge': '32,500,000 - 126,000,000',
	'SlotsSmall': '30-36',
	'SlotsMedium': '36-40',
	'SlotsLarge': '40-48',
	'TechSlotsSmall': '12-18',
	'TechSlotsMedium': '18-24',
	'TechSlotsLarge': '20-30',
}

const Shuttle = {
	'CostSmall': '2,070,000 - 12,650,000',
	'CostMedium': '4,400,000 - 22,500,000',
	'SlotsSmall': '24-32',
	'SlotsMedium': '28-36',
	'TechSlotsSmall': '12-19',
	'TechSlotsMedium': '18-26',
}

const Living = {
	'CostMedium': '21,850,000',
	'SlotsMedium': '36',
	'TechSlotsMedium': '30',
}
...
function calcS(econ_input, codeId, type_input) {
	...
	document.getElementById(codeId).innerHTML = chanceSentence
}
...
function calcInv(type_inputId, subtype_inputId, inventory_inputId) {
	...
	const subtype = document.getElementById(subtype_inputId).value
...
function showHideStarshipSelects(type_inputId, subtype_inputId, exotic_inputId, pilot_inputId, maneuver_inputId, damage_inputId, shield_inputId, warp_inputId, inventory_inputId, planet_inputId, moon_inputId, axes_inputId, economy_inputId) {
	...
	const type = document.getElementById(type_inputId).value
	const subtype = document.getElementById(subtype_inputId)
	const exotic = document.getElementById(exotic_inputId)
	const pilot = document.getElementById(pilot_inputId)
	const inventory = document.getElementById(inventory_inputId)
	const maneuver = document.getElementById(maneuver_inputId)
	const damage = document.getElementById(damage_inputId)
	const shield = document.getElementById(shield_inputId)
	const warp = document.getElementById(warp_inputId)
	const economy = document.getElementById(economy_inputId)
	const planet = document.getElementById(planet_inputId)
	const moon = document.getElementById(moon_inputId)
	const axes = document.getElementById(axes_inputId)

	const subtypetr = subtype.parentElement.parentElement
	const exotictr = exotic.parentElement.parentElement
	const pilottr = pilot.parentElement.parentElement
	const inventorytr = inventory.parentElement.parentElement
	const maneuvertr = maneuver.parentElement.parentElement
	const damagetr = damage.parentElement.parentElement
	const shieldtr = shield.parentElement.parentElement
	const warptr = warp.parentElement.parentElement
	const economytr = economy.parentElement.parentElement
	const planettr = planet.parentElement.parentElement
	const moontr = moon.parentElement.parentElement
	const axestr = axes.parentElement.parentElement
...
function costSlotCalc(type_inputId, inventory_codeId, cost_codeId, slots_codeId, techslots_codeId) {
...
function appearanceDropdowns(type_inputId, secParts_inputId, accessories_inputId, miscParts_inputId) {
...
function appearanceSentence(name_inputId, type_inputId, subtype_inputId, exotic_inputId, mainColour_inputId, secColour_inputId, secParts_inputId, accessories_inputId, miscParts_inputId, appearance_inputId) {
	...
	const exotic = document.getElementById(exotic_inputId).value;

	const mainColour = document.getElementById(mainColour_inputId).value;
	const secColour = document.getElementById(secColour_inputId).value;

	const secParts = document.getElementById(secParts_inputId).value;
	const accessories = document.getElementById(accessories_inputId).value;
	const miscParts = document.getElementById(miscParts_inputId).value;
	...
	const output = `${name} is ${enPrefix(mainColour)} ${mainColour} ${type.toLowerCase()} of the ${subtype.toLowerCase()} subtype with ${secColour} accents. It features ${secParts.toLowerCase()}, ${accessories.toLowerCase()} and ${miscParts.toLowerCase()}.`
