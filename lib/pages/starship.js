...
function albumOther() {
	...
	albumElements.output.albumOther.innerText = `<br>${prop1} ${prop2}`;
	albumElements.output.albumName.innerText = pageData.name;
}
...
function albumType() {
	albumElements.output.albumType.innerText = 'catalog';
}