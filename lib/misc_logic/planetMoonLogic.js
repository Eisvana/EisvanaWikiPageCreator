...
function addFlora(element) {
	...
	<div class="tableCell data" data-flora="section${i}" data-section="flora flora${i}">
	<input data-dest-noauto="floraElements${i}" type="text" list="planetItemResources" id="floraResourcePrimInput${i}" oninput="floraMineralResourceLinks(this)">
	</div>
	<div class="tableCell text" data-flora="section${i}" data-section="flora flora${i}">
		<label for="floraResourceSecInput${i}">Secondary resource:</label>
	</div>
	<div class="tableCell data" data-flora="section${i}" data-section="flora flora${i}">
		<input data-dest-noauto="floraElements${i}" type="text" list="planetItemResources" id="floraResourceSecInput${i}" oninput="floraMineralResourceLinks(this)">
	</div>
	<div class="tableCell text" data-flora="section${i}" data-section="flora flora${i}">
...
// TODO: mineral datalists, mineral inputs
...
function addGenus(element = null) {
	...
	const linkedGenera = sortObj(structuredClone(genera));
...
function resetExternal() {
	const sections = document.querySelectorAll('[data-moon], [data-resource], [data-fauna], [data-flora], [data-minerals]');
